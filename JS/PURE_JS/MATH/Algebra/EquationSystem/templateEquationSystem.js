...
*/
const templatEquationSystem = (equation1, equation2, moduleOfEquationSystem = linearModule, explicitForm = 1) => {
  ...
  // Находим значение первого [x], для подстановки во второе уравнение ->
  const primaryX = c1 / a1; 
  // Коэффициэнт первого [y] для сложения со вторым ->
  const y1 = (-b1 / a1) * a2; 
