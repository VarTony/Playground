...
console.log(`result2 = ${result2}`); //result2 = 10.658141036401503 Здесь можно заметить, что результат больше предыдущего и имеют явную зависимость от предела константированого в dx;
